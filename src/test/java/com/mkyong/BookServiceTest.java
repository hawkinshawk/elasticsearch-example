...
//
//        Book book = new Book("1001", "Elasticsearch Basics", "Rambabu Posa", LocalDate.now());
...
//
//        bookList.add(new Book("1001", "Elasticsearch Basics", "Rambabu Posa", LocalDate.now()));
//        bookList.add(new Book("1002", "Apache Lucene Basics", "Rambabu Posa", LocalDate.now()));
//        bookList.add(new Book("1003", "Apache Solr Basics", "Rambabu Posa", LocalDate.now()));
//        bookList.add(new Book("1007", "Spring Data + ElasticSearch", "Rambabu Posa", LocalDate.now()));
//        bookList.add(new Book("1008", "Spring Boot + MongoDB", "Mkyong", LocalDate.now()));
//
